...
# jpackage utility.
#
Set-Variable -Name VENDOR_STRING -Value "pedalbox"
...
#
Set-Variable -Name PROJECT -Value PedalFx
Set-Variable -Name VERSION -Value "15.0"
Set-Variable -Name MAINMODULE -Value org.example
Set-Variable -Name MAINCLASS -Value org.example.App
...
$jdk_version = (Get-Command java | Select-Object -ExpandProperty Version).tostring().split(".")
